!(function (e) {
      ...
      __calculateDatesWhenInFirstWeek(e, t) {
        ...
        if (a.length < 7) {
          ...
          for (
            ...
            ((n = 12), (t -= 1), (e = d.thisMonthDays(t, n))); s;
  ...
  function (e, t, a) {
          ...
          g({
              ...
              'calendar.selectedDay': [{
                ...
                lunar: (0, l.default)(i).getCalendarConfig().showLunar ?
                  d.default.solar2lunar(e, t, a) : null
              }],
    ...
    function S(e, t, a, n) {
      ...
      if (+c != +e || +l != +t || +d != +a) {
        if (o) return (0, s.default)(i).jump({
          year: e,
          month: t,
          day: a
        });
